...
/**
 * 1. FileName   : WfIdGeneratorService.java
 * 2. Package    : com.samsung.ciam.services
 * 3. Comments   : 워크플로우 ID(wf_id)를 생성하기 위한 서비스 클래스
 * 4. Author     : 서정환
 ...
 */
@Service
public class WfIdGeneratorService {
     ...
     * <PRE>
     * 1. 설명
     *    새로운 wf_id를 생성하는 메소드로, 오늘 날짜와 연속 번호를 조합하여 생성
     * 2. 사용법
     *    현재 날짜와 연결된 wf_id의 최대 값을 조회하여 새로운 ID 생성
     * 3. 예시 데이터
     *    - Input: 없음
     *    - Output: "20241104_0001" (오늘 날짜가 2024년 11월 4일인 경우)
     * </PRE>
     * @return 생성된 wf_id 문자열
     */
